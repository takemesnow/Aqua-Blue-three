...
UUID=${UUID:-'63e7b834-337c-43cc-ab09-d3f3df662b09'}
VMESS_WSPATH=${VMESS_WSPATH:-'/63e7b834-337c-43cc-ab09-d3f3df662b09-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/63e7b834-337c-43cc-ab09-d3f3df662b09-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/63e7b834-337c-43cc-ab09-d3f3df662b09-trojan'}
SS_WSPATH=${SS_WSPATH:-'/63e7b834-337c-43cc-ab09-d3f3df662b09-shadowsocks'}
